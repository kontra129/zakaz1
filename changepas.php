...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="chps1.php" method="POST">
    ...
    <div class="form-field">
      ...
      <div class="form-field">
      <input type="password" id="new_password" placeholder="Новый пароль" name="new_password" />
      </div>

      <div class="form-field">
        <input type="password" id="password_confirmation" placeholder="Повторите пароль" name="password_confirmation">
      </div>
      
      <div class="form-buttons" type="submit">
        <button class="button" type="submit" name="cp">Изменить</button>
      </div>
    </form>
