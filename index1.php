...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php if (isset($_SESSION['logged_user']) ) : ?>
      ...
      <h1 align="center">Можете дополнить данные аккаунта <a href="change.php">Дополнить</a></h1>
      <h1 align="center"><a href="changepas.php">Поменять пароль</a></h1> 
      <h1 align="center"><a href="/logout.php">Выйти</a></h1>
    <?php else : ?>
      <main>  
      ...
      <div class="register-form-container">
        ...
        <form action="login.php" method="POST">
          ...
          <div class="form-buttons" type="submit">
            <button class="button" type="submit" name="do_login">Вход</button>
          </div>
        </form>
    </main>
  <?php endif; ?>
