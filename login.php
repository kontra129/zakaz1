    ...
    if (isset($data['do_login'])) {
      ...
      if ($user) {
        if (password_verify($data['password'], $user->password)) {
          ...
          echo '<h1 align="center">Можете дополнить данные аккаунта <a href="change.php">Дополнтить</a></h1>';
          echo '<h1 align="center"><a href="changepas.php">Поменять пароль</a></h1>';
          echo '<h1 align="center"><a href="/logout.php">Выйти</a></h1>';
        } else {
